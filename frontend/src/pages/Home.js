    ...
    <div className='p-2 md:p-4'>
      <div className='md:flex gap-4 py-2'>
        ...
        <div className='md:w-1/2'>
          ...
          <h2 className='text-4xl md:text-7xl font-bold py-3'>The Fastest Delivery in <span className='text-red-500 text-'>Your Home</span></h2>
          ...
          <Link to={"/menu/66be43a8bf56d705bc25bd99"}><button className='font-bold bg-red-500 text-slate-200 px-4 py-2 rounded-md'>Order Now</button></Link>
        </div>
