...
const CardFeature = ({ name, image, category, price, loading, id }) => {
    ...
    return (
        <div className='w-full min-w-[200px] max-w-[200px] bg-white hover:shadow-2xl drop-shadow-lg py-5 px-4 cursor-pointer flex flex-col'>
            {
                image ? <>
                    ...
                    <button className='bg-yellow-500 py-1 mt-2 rounded-md hover:bg-yellow-600 w-full' onClick={handleAddCartProduct}>Add to Cart</button>
