            ...
            <div className='flex flex-col gap-1 w-full'>
                ...
                <div className='flex justify-between'>
                    <div className='flex gap-3 items-center'>
                        <button onClick={() => dispatch(increaseQty(id))} className='bg-slate-300 py-1 mt-2 rounded-sm hover:bg-slate-400 p-1'><TbPlus /></button>
                        <p className='font-semibold p-1'>{qty}</p>
                        <button onClick={() => dispatch(decreaseQty(id))} className='bg-slate-300 py-1 mt-2 rounded-sm hover:bg-slate-400 p-1'><TbMinus /></button>
                    </div>
